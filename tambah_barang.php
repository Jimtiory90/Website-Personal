...
//$homepageclass = new homepageclass;
 ?>
    <form action='simpan_barang.php' METHOD='POST' enctype='multipart/form-data' name='pelayanan'>  
	  <TABLE>
	    <TR>
		  <TD width='250' height='25'>Jenis</TD>
		  <TD><input type='text' name='kd_jenis''></TD>
		</TR>
		<TR>
		  <TD width='250' height='25'>Merek</TD>
		  <TD><input type='text' name='kd_merek'></TD>
		</TR>
		<TR>
